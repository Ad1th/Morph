...
## Corpus Check
- 61 files · ~70,709 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 550 nodes · 964 edges · 64 communities detected
- Extraction: 56% EXTRACTED · 44% INFERRED · 0% AMBIGUOUS · INFERRED: 421 edges (avg confidence: 0.67)
...
3. `RunResult` - 27 edges
4. `EnvironmentProfile` - 25 edges
5. `run_with_telemetry()` - 24 edges
6. `MockAdapter` - 23 edges
7. `ProxyServer` - 22 edges
8. `TrialBatch` - 22 edges
9. `RuntimeController` - 21 edges
10. `MacOSAdapter` - 21 edges
...
Cohesion: 0.06
Nodes (34): BaseAdapter, ProxyAdapter, Abstract interface for operating system and network environment adapters., Return dictionary of environment variables to inject into target process., Cross-platform fallback adapter using user-space TCP proxy and environment varia, get_default_adapter(), Runtime Controller: orchestrates environment condition reproduction and executio, Apply all relevant conditions from the environment profile via the active adapte (+26 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (44): classify_failure(), Causal classification: distinguishes an application bug from a failure that is g, application_internal: baseline already fails often, regardless of environment., compare_failure_rates(), ComparisonResult, Statistical comparison results: baseline vs. treatment, and threshold search., ThresholdResult, compare_batches() (+36 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (38): BaseModel, capture_environment(), Capture orchestrator: runs all collectors and assembles an EnvironmentProfile., Collects the current machine's environment into a structured profile., collect_cpu(), CPU collector: architecture, core counts, clock speed., collect_filesystem(), Filesystem collector: detects case sensitivity by probing a temp directory. (+30 more)
...
Cohesion: 0.12
Nodes (19): _apply_locale(), _base_name(), _candidates(), _env_requested(), _Handler, main(), _parse_buggy(), _parse_fixed() (+11 more)

### Community 9 - "Community 9"
Cohesion: 0.16
Nodes (20): delete_regression(), list_regressions(), load_regression(), Flight Recorder artifact management for .morph/ regression bundles., Delete a regression bundle directory., Save a RegressionArtifact as a structured directory bundle under base_dir/regres, Load and reconstruct a RegressionArtifact from a bundle directory or regression, Scan base_dir and return all valid RegressionArtifact bundles. (+12 more)
...
Cohesion: 0.5
Nodes (1): Entry point: `python -m apps.race run|test [--fixed]`.
...
## Knowledge Gaps
- **132 isolated node(s):** `Morph: reproduce environment conditions and isolate the cause of failures.`, `User-space TCP proxy: cross-platform network latency and packet-loss simulation.`, `Actual bound listen port (resolved after start() when listen_port=0).`, `Relay chunks from reader to writer, injecting latency and packet loss.`, `Runnable check: latency is observable, and 100% loss actually blocks delivery.` (+127 more)
...
- **Thin community `Community 23`** (2 nodes): `What Morph Actually Reproduces (Targeted vs Not Claimed)`, `README Limitations Section`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (2 nodes): `Delta Debugging for CPS with Flaky Test Executions (arXiv 2607.25695)`, `Prior Art and What's Actually New`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (2 nodes): `Demo Failure Corpus (demo_apps/)`, `Demo Failure Corpus A-D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (2 nodes): `Recommended Stack Decision Rationale (Section 23)`, `Python Whole-Runtime Stack Decision`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (2 nodes): `Statistical Comparison Module (comparison.py)`, `compare_failure_rates() Implementation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 42`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (1 nodes): `Failure A: Simple Timeout`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (1 nodes): `Failure C: CPU Constraint Race Condition`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (1 nodes): `Failure D: Locale Date Formatting`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (1 nodes): `The Problem: It Works On My Machine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (1 nodes): `Environment-Triggered Failure`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `Architecture Core Loop`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (1 nodes): `RegressionArtifact Schema`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (1 nodes): `Error Handling Rules`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (1 nodes): `Security and Privacy Section`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (1 nodes): `Signature Interaction: Enter Environment`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (1 nodes): `OS-Adaptive Workspace`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (1 nodes): `Color System`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (1 nodes): `Typography System`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (1 nodes): `Regression Test Creation Flow`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (1 nodes): `Hackathon Context and Timeline`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (1 nodes): `Team and Ownership (Adith/Parth/Sarthak/Rishita)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (1 nodes): `Product Scope: Pre/Post-Deployment`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `CI Requirements (Section 22)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (1 nodes): `Hard Cuts List (Section 36)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (1 nodes): `Review 1 Triage Cut Order (Section 38)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 63`** (1 nodes): `Final Success Criteria (Section 40)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **What is the exact relationship between `Immersive Landing Page Concept` and `24-Hour Build Plan Phases`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `RunResult` connect `Community 0` to `Community 1`, `Community 2`, `Community 7`, `Community 11`, `Community 16`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `run_with_telemetry()` connect `Community 7` to `Community 0`, `Community 10`, `Community 11`, `Community 5`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `_run()` connect `Community 4` to `Community 0`?**

...
## Corpus Check
- 43 files · ~54,695 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 451 nodes · 786 edges · 56 communities detected
- Extraction: 53% EXTRACTED · 47% INFERRED · 0% AMBIGUOUS · INFERRED: 370 edges (avg confidence: 0.67)
...
1. `ProxyAdapter` - 33 edges
2. `BaseAdapter` - 27 edges
3. `run_with_telemetry()` - 24 edges
4. `RunResult` - 23 edges
5. `MockAdapter` - 23 edges
6. `ProxyServer` - 22 edges
7. `TrialBatch` - 22 edges
8. `MacOSAdapter` - 21 edges
9. `WindowsAdapter` - 21 edges
10. `LinuxAdapter` - 21 edges
...
Cohesion: 0.06
Nodes (30): BaseAdapter, ProxyAdapter, Abstract interface for operating system and network environment adapters., Return dictionary of environment variables to inject into target process., Cross-platform fallback adapter using user-space TCP proxy and environment varia, get_default_adapter(), Runtime Controller: orchestrates environment condition reproduction and executio, Apply all relevant conditions from the environment profile via the active adapte (+22 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (46): BaseModel, classify_failure(), Causal classification: distinguishes an application bug from a failure that is g, application_internal: baseline already fails often, regardless of environment., compare_failure_rates(), ComparisonResult, Statistical comparison results: baseline vs. treatment, and threshold search., ThresholdResult (+38 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (35): capture_environment(), Capture orchestrator: runs all collectors and assembles an EnvironmentProfile., Collects the current machine's environment into a structured profile., collect_cpu(), CPU collector: architecture, core counts, clock speed., collect_filesystem(), Filesystem collector: detects case sensitivity by probing a temp directory., collect_locale() (+27 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (13): ABC, BaseAdapter interface and cross-platform ProxyAdapter., Apply network conditions (latency, packet loss, bandwidth limit)., Apply CPU core count or throttle restrictions., Apply memory restrictions., Apply locale and timezone settings., Clean up all applied conditions and restore normal host state., Return capabilities dict: {'network': bool, 'cpu': bool, 'memory': bool, 'locale (+5 more)
...
## Knowledge Gaps
- **107 isolated node(s):** `Morph: reproduce environment conditions and isolate the cause of failures.`, `User-space TCP proxy: cross-platform network latency and packet-loss simulation.`, `Actual bound listen port (resolved after start() when listen_port=0).`, `Relay chunks from reader to writer, injecting latency and packet loss.`, `Runnable check: latency is observable, and 100% loss actually blocks delivery.` (+102 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 19`** (2 nodes): `Morph: reproduce environment conditions and isolate the cause of failures.`, `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (2 nodes): `What Morph Actually Reproduces (Targeted vs Not Claimed)`, `README Limitations Section`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (2 nodes): `Delta Debugging for CPS with Flaky Test Executions (arXiv 2607.25695)`, `Prior Art and What's Actually New`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 22`** (2 nodes): `Statistical Comparison Module (comparison.py)`, `compare_failure_rates() Implementation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 23`** (2 nodes): `Demo Failure Corpus (demo_apps/)`, `Demo Failure Corpus A-D`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (2 nodes): `Recommended Stack Decision Rationale (Section 23)`, `Python Whole-Runtime Stack Decision`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (2 nodes): `Threshold Search Module (threshold.py)`, `search_threshold() Implementation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (1 nodes): `Actual bound listen port (resolved after start() when listen_port=0).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 34`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (1 nodes): `Failure A: Simple Timeout`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (1 nodes): `Failure C: CPU Constraint Race Condition`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (1 nodes): `Failure D: Locale Date Formatting`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (1 nodes): `The Problem: It Works On My Machine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (1 nodes): `Environment-Triggered Failure`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (1 nodes): `Architecture Core Loop`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (1 nodes): `RegressionArtifact Schema`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (1 nodes): `Error Handling Rules`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (1 nodes): `Security and Privacy Section`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (1 nodes): `Signature Interaction: Enter Environment`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (1 nodes): `OS-Adaptive Workspace`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (1 nodes): `Color System`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (1 nodes): `Typography System`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `Regression Test Creation Flow`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (1 nodes): `Hackathon Context and Timeline`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (1 nodes): `Team and Ownership (Adith/Parth/Sarthak/Rishita)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (1 nodes): `Product Scope: Pre/Post-Deployment`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (1 nodes): `CI Requirements (Section 22)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (1 nodes): `Hard Cuts List (Section 36)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (1 nodes): `Review 1 Triage Cut Order (Section 38)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (1 nodes): `Final Success Criteria (Section 40)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **What is the exact relationship between `Immersive Landing Page Concept` and `24-Hour Build Plan Phases`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `RunResult` connect `Community 1` to `Community 0`, `Community 2`, `Community 5`, `Community 9`, `Community 12`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `run_with_telemetry()` connect `Community 5` to `Community 9`, `Community 3`, `Community 1`, `Community 7`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `TrialBatch` connect `Community 1` to `Community 0`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Are the 23 inferred relationships involving `ProxyAdapter` (e.g. with `RuntimeController` and `Runtime Controller: orchestrates environment condition reproduction and executio`) actually correct?**
  _`ProxyAdapter` has 23 INFERRED edges - model-reasoned connections that need verification._
- **Are the 19 inferred relationships involving `BaseAdapter` (e.g. with `RuntimeController` and `Runtime Controller: orchestrates environment condition reproduction and executio`) actually correct?**
  _`BaseAdapter` has 19 INFERRED edges - model-reasoned connections that need verification._